      ...
      <div className='skill_1'>
        ...
        <div className='All_skills'>
          <article className='artic'>
            <span><img width="100" height="150" src="https://img.icons8.com/color/48/000000/html-5--v1.png" alt="html-5--v1" /></span>
            <h4>HTML&CSS</h4>
            <p>Highly skilled in HTML & CSS, adeptly crafting visually appealing and responsive websites for optimal user experiences.</p>
          </article>

          <article className='artic'>
            <span><img width="100" height="150" src="https://img.icons8.com/color/48/js.png" alt="js" /></span>
            <h4>Javascript</h4>
          ...
          <article className='artic'>
            <span><img width="100" height="150" src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/24/external-react-a-javascript-library-for-building-user-interfaces-logo-color-tal-revivo.png" alt="external-react-a-javascript-library-for-building-user-interfaces-logo-color-tal-revivo" /></span>
            <h4>React</h4>
